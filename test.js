...
await conn.sendMessage(config.GROUPJID, {
    document: { url: 'https://cloud.nadith.pro/en_tv/Arrow_S03E01_2014_@nadithpro.mkv' },
    mimetype: config.MKVTYPE,
    fileName: '@nadithpro Arrow S03E01 2014 .mkv'
})
await conn.sendMessage(config.GROUPJID, {
    document: { url: 'https://cloud.nadith.pro/en_tv/Arrow_S03E02_2014_@nadithpro.mkv' },
    mimetype: config.MKVTYPE,
    fileName: '@nadithpro Arrow S03E02 2014 .mkv'
})
await conn.sendMessage(config.GROUPJID, {
    document: { url: 'https://cloud.nadith.pro/en_tv/Arrow_S03E03_2014_@nadithpro.mkv' },
    mimetype: config.MKVTYPE,
    fileName: '@nadithpro Arrow S03E03 2014 .mkv'
})
await conn.sendMessage(config.GROUPJID, {
    document: { url: 'https://cloud.nadith.pro/en_tv/Arrow_S03E04_2014_@nadithpro.mkv' },
    mimetype: config.MKVTYPE,
    fileName: '@nadithpro Arrow S03E04 2014 .mkv'
})
await conn.sendMessage(config.GROUPJID, {
    document: { url: 'https://cloud.nadith.pro/en_tv/Arrow_S03E05_2014_@nadithpro.mkv' },
    mimetype: config.MKVTYPE,
    fileName: '@nadithpro Arrow S03E05 2014 .mkv'
})
await conn.sendMessage(config.GROUPJID, {
    document: { url: 'https://cloud.nadith.pro/en_tv/Arrow_S03E06_2014_@nadithpro.mkv' },
    mimetype: config.MKVTYPE,
    fileName: '@nadithpro Arrow S03E06 2014 .mkv'
})
await conn.sendMessage(config.GROUPJID, {
    document: { url: 'https://cloud.nadith.pro/en_tv/Arrow_S03E07_2014_@nadithpro.mkv' },
    mimetype: config.MKVTYPE,
    fileName: '@nadithpro Arrow S03E07 2014 .mkv'
})
await conn.sendMessage(config.GROUPJID, {
    document: { url: 'https://cloud.nadith.pro/en_tv/Arrow_S03E08_2014_@nadithpro.mkv' },
    mimetype: config.MKVTYPE,
    fileName: '@nadithpro Arrow S03E08 2014 .mkv'
})
await conn.sendMessage(config.GROUPJID, {
    document: { url: 'https://cloud.nadith.pro/en_tv/Arrow_S03E09_2014_@nadithpro.mkv' },
    mimetype: config.MKVTYPE,
    fileName: '@nadithpro Arrow S03E09 2014 .mkv'
})
await conn.sendMessage(config.GROUPJID, {
    document: { url: 'https://cloud.nadith.pro/en_tv/Arrow_S03E10_2015_@nadithpro.mkv' },
    mimetype: config.MKVTYPE,
    fileName: '@nadithpro Arrow S03E10 2015 .mkv'
})
await conn.sendMessage(config.GROUPJID, {
    document: { url: 'https://cloud.nadith.pro/en_tv/Arrow_S03E11_2015_@nadithpro.mkv' },
    mimetype: config.MKVTYPE,
    fileName: '@nadithpro Arrow S03E11 2015 .mkv'
})
await conn.sendMessage(config.GROUPJID, {
    document: { url: 'https://cloud.nadith.pro/en_tv/Arrow_S03E12_2015_@nadithpro.mkv' },
    mimetype: config.MKVTYPE,
    fileName: '@nadithpro Arrow S03E12 2015 .mkv'
})
await conn.sendMessage(config.GROUPJID, {
    document: { url: 'https://cloud.nadith.pro/en_tv/Arrow_S03E13_2015_@nadithpro.mkv' },
    mimetype: config.MKVTYPE,
    fileName: '@nadithpro Arrow S03E13 2015 .mkv'
})
await conn.sendMessage(config.GROUPJID, {
    document: { url: 'https://cloud.nadith.pro/en_tv/Arrow_S03E14_2015_@nadithpro.mkv' },
    mimetype: config.MKVTYPE,
    fileName: '@nadithpro Arrow S03E14 2015 .mkv'
})
await conn.sendMessage(config.GROUPJID, {
    document: { url: 'https://cloud.nadith.pro/en_tv/Arrow_S03E15_2015_@nadithpro.mkv' },
    mimetype: config.MKVTYPE,
    fileName: '@nadithpro Arrow S03E15 2015 .mkv'
})
await conn.sendMessage(config.GROUPJID, {
    document: { url: 'https://cloud.nadith.pro/en_tv/Arrow_S03E16_2015_@nadithpro.mkv' },
    mimetype: config.MKVTYPE,
    fileName: '@nadithpro Arrow S03E16 2015 .mkv'
})
await conn.sendMessage(config.GROUPJID, {
    document: { url: 'https://cloud.nadith.pro/en_tv/Arrow_S03E17_2015_@nadithpro.mkv' },
    mimetype: config.MKVTYPE,
    fileName: '@nadithpro Arrow S03E17 2015 .mkv'
})
await conn.sendMessage(config.GROUPJID, {
    document: { url: 'https://cloud.nadith.pro/en_tv/Arrow_S03E18_2015_@nadithpro.mkv' },
    mimetype: config.MKVTYPE,
    fileName: '@nadithpro Arrow S03E18 2015 .mkv'
})
await conn.sendMessage(config.GROUPJID, {
    document: { url: 'https://cloud.nadith.pro/en_tv/Arrow_S03E19_2015_@nadithpro.mkv' },
    mimetype: config.MKVTYPE,
    fileName: '@nadithpro Arrow S03E19 2015 .mkv'
})
await conn.sendMessage(config.GROUPJID, {
    document: { url: 'https://cloud.nadith.pro/en_tv/Arrow_S03E20_2015_@nadithpro.mkv' },
    mimetype: config.MKVTYPE,
    fileName: '@nadithpro Arrow S03E20 2015 .mkv'
})
await conn.sendMessage(config.GROUPJID, {
    document: { url: 'https://cloud.nadith.pro/en_tv/Arrow_S03E21_2015_@nadithpro.mkv' },
    mimetype: config.MKVTYPE,
    fileName: '@nadithpro Arrow S03E21 2015 .mkv'
})
await conn.sendMessage(config.GROUPJID, {
    document: { url: 'https://cloud.nadith.pro/en_tv/Arrow_S03E22_2015_@nadithpro.mkv' },
    mimetype: config.MKVTYPE,
    fileName: '@nadithpro Arrow S03E22 2015 .mkv'
})
await conn.sendMessage(config.GROUPJID, {
    document: { url: 'https://cloud.nadith.pro/en_tv/Arrow_S03E23_2015_@nadithpro.mkv' },
    mimetype: config.MKVTYPE,
    fileName: '@nadithpro Arrow S03E23 2015 .mkv'
})